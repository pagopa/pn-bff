...
public class PnBffRestConstants {
    ...
    public static final String CX_LANGUAGE_HEADER = "x-pagopa-pn-language";
    ...
    public static final String NOTIFICATION_SENT_TIMELINE_PATH = NOTIFICATION_SENT_PATH + "/timeline";
    ...
    public static final String SENT_INFORMAL_NOTIFICATION_TIMELINE_PATH = SENT_INFORMAL_NOTIFICATION_PATH + "/timeline";
    public static final String SENT_INFORMAL_NOTIFICATION_DOCUMENT_PATH = SENT_INFORMAL_NOTIFICATION_PATH + "/attachments/documents/{docIdx}";
    public static final String SENT_INFORMAL_NOTIFICATION_ATTACHMENT_PATH = SENT_INFORMAL_NOTIFICATION_PATH + "/attachments/payment/{recipientIdx}/{attachmentName}";
