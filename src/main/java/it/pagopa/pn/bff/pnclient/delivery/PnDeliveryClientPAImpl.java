...
public class PnDeliveryClientPAImpl {
    ...
    public Mono<FullSentNotificationV29> getSentNotification(String xPagopaPnUid, CxTypeAuthFleet xPagopaPnCxType,
                                                             String xPagopaPnCxId, String iun,
                                                             List<String> xPagopaPnCxGroups) {
        log.logInvokingExternalService(PnLogger.EXTERNAL_SERVICES.PN_DELIVERY, "getSentNotificationV29");

        return senderReadB2BApi.getSentNotificationV29(
                xPagopaPnUid,
                xPagopaPnCxType,
                xPagopaPnCxId,
                iun,
    ...
    public Mono<NewNotificationResponse> newSentNotification(String xPagopaPnUid, CxTypeAuthFleet xPagopaPnCxType,
        ...
        return newNotificationApi.sendNewNotificationV26(
                xPagopaPnUid,
                xPagopaPnCxType,
                xPagopaPnCxId,
                "WEB",
