...
/**
 * Mapstruct mapper interface, used to map the FullSentNotificationV27
...
public interface NotificationSentDetailMapper {
    ...
    /**
     * Maps a FullSentNotificationV27 to a BffFullNotificationV1
     *
     * @param notification the FullSentNotificationV27 to map
     * @return the mapped BffFullNotificationV1
     */
    BffFullNotificationV1 mapSentNotificationDetail(FullSentNotificationV27 notification);
